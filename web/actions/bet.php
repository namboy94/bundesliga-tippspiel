...
foreach($matches as $match) {
    ...
    if (isset($previous_bets[$match['id']])) {
        ...
        $args = array($_SESSION['id'], $match['id'], $_POST[$match['team_one']], $_POST[$match['team_two']], false);
        $db->queryWrite('INSERT INTO bets (user, match_id, team_one, team_two, locked) VALUES (?, ?, ?, ?, ?)',
            'iiiii', $args);
    }
