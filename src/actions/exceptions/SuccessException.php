...
class SuccessException extends ActionException {
	...
	public function __construct(string $messageIdentifier, string $redirect) {
		parent::__construct($messageIdentifier, "success", $redirect);
	}
}